...
class DinnerFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view: View = inflater.inflate(R.layout.fragment_dinner, container, false)
        ...
        val titleTextView = view.findViewById<TextView>(R.id.dinnertitle)
        val descriptionTextView = view.findViewById<TextView>(R.id.dinnerdescription)
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(title: String, description: String): DinnerFragment {
